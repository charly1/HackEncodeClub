...
function softwareProvider(WrappedComponent) {
  class SoftwareFunctions extends React.Component {
    constructor(props) {
      super(props);
  ...
  softwareProvider.displayName = `portisWrapper(${getDisplayName(WrappedComponent)})`;

  return SoftwareFunctions;
}
